...
function display_help() {
    echo "Usage: $0 <MIMICIV_RAW_DIR> <MIMICIV_PRE_MEDS_DIR> <MIMICIV_MEDS_EXTRACT_DIR>"
    echo
...
EVENT_CONVERSION_CONFIG_FP="$(pwd)/configs/event_configs_qa.yaml"
PIPELINE_CONFIG_FP="$(pwd)/configs/extract_MIMIC.yaml"
PRE_MEDS_PY_FP="$(pwd)/pre_MEDS_qa.py"
