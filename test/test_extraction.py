...
def find_project_root(indicators=(".git", "pyproject.toml", ".env")):
    """Find the project root by looking for indicator files or directories."""
...
def setup_project_root(dotenv=True, pythonpath=True, cwd=True):
    """Set up the project root, load .env, and adjust PYTHONPATH."""
...
# Use the setup function to initialize your project environment
root = setup_project_root(dotenv=True, pythonpath=True, cwd=True)

# Now you can proceed with your script, knowing the project root is set up
...
239684,"05/12/2010, 21:41:51","05/15/2010, 22:27:19",CARDIAC,"05/12/2010, 21:48:51",101.6,94.0
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        try:
            for split, expected_df_L in MEDS_OUTPUTS.items():
                ...
                pl.Config.set_tbl_rows(100)  # Set the number of rows to display
